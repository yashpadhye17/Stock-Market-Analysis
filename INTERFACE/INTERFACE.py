...
def register():
    ...
    file=open(name_info +"register.txt","w")
...
Label(root,text="Python Registration Form", font="arial 25").pack(pady=5)
...
phoneEntry=Entry(root, textvariable=phoneValue,width=30, bd=2, font=320)
genderEntry=Entry(root, textvariable=genderValue,width=30, bd=2, font=320)
emailEntry=Entry(root, textvariable=emailValue, width=30, bd=2, font=320)
